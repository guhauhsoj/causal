...
cov_balance_plot(title= "regression estimator", Bcheck_reg)
...
cov_balance_plot(title= "HT estimator", Bcheck_HT)
...
cov_balance_plot(title= "Hajek estimator", Bcheck_hj)
...
cov_balance_plot(title= "Doubly Robust estimator", Bcheck_dr)
